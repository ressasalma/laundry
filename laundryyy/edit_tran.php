    ...
    <div class="container-scroller">
        ...
        if (!isNaN(total)) {
            ...
            document.getElementById("total").textContent = "Input tidak valid";
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="diskon" id="diskon" class="form-control">
                                                        <option value="<?php echo $tran['diskon']; ?>">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="pajak" id="pajak" class="form-control">
                                                        <option value="<?php echo $tran['pajak']; ?>">
                                                            <?php echo $tran['pajak']; ?>
                                                        </option>
                                                        <?php
                                            ...
                                            <?php if (!empty($tran['bukti_tran'])) { ?>
                                            <div class="form-group" id="divPhoto">
                                                <div class="col-xs-3">
                                                    <label>Bukti Pembayaran</label>
                                                </div>
                                                <div class="col-xs-3" id="divPhoto1" style="height:150px;">
                                                    <a href="../home/img/<?php echo $tran['bukti_tran']; ?>">
                                                        <img src="../home/img/<?php echo $tran['bukti_tran']; ?>"
                                                            id="output" style="width:130px;height:150px;" />
                                                    </a>
                                                </div>
                                                <br>
                                            </div>
