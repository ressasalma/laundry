...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        if ($foto !== false) {
            $query = "INSERT INTO tb_detail_transaksi (id, id_transaksi, id_paket, qty, keterangan, bukti_tran) VALUES (?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($query);
            $stmt->bind_param("iiisss", $id_detail, $id, $id_paket, $qty, $ket, $foto);
            if ($stmt->execute()) {
                echo "<script>
            ...
            <div class="col-md-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tlp" class="form-control" type="number" maxlength="13" required />
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
